...
public class GameUtils {
    ...
    public static GameData toGameData(final Game game) {
        ...
        return GameData.builder().homeTeam(homeTeamRelevantData)
                .awayTeam(awayTeamRelevantData)
                .id(game.getGameId())
                .homeTeamId(game.getHTeam().getTeamId())
                .awayTeamId(game.getVTeam().getTeamId())
                .homeTeamScore(Integer.parseInt(game.getHTeam().getScore().getPoints()))
                .awayTeamScore(Integer.parseInt(game.getVTeam().getScore().getPoints()))
                .build();
    }
